...
const badgeVariants = cva(
  `bg-primary absolute text-sm font-semibold flex items-center justify-center text-primary-foreground lg:-top-8 lg:left-0 lg:w-full lg:h-8  right-0 w-fit h-6 z-50 rounded-none px-2 font-medium`,
  {
    variants: {
      position: {
